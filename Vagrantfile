...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "amulyasharma-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/aaws"
  #   chef.validation_client_name = "aaws-validator"
  #   chef.validation_key_path = ".chef/aaws-validator.pem"
  # end
end
